...
<body>
    ...
    <form id="formPassChange2" runat="server" ><br /><br />
       <br /><br /><asp:Label ID="lblCOd" runat="server" Text="Código de validación:" style="font-size:larger;"></asp:Label><br /><br />
        ...
        <br /><br /><asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPass" ControlToValidate="txtPass2" ErrorMessage="Las contraseñas introducidas no coinciden" SetFocusOnError="true"></asp:CompareValidator>
        <br /><br />           
