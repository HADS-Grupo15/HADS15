...
<body>
    ...
    <div>
        <asp:HyperLink ID="hyperPass" runat="server" PostBackUrl="~/Registro.aspx">¿Has olvidado tu contraseña?</asp:HyperLink><br /><br />
        <asp:HyperLink ID="hyperRegister" runat="server" PostBackUrl="~/Registro.aspx" >¿Aún no te has registrado?</asp:HyperLink><br />
    </div>
   </div>
</body>
</html>
